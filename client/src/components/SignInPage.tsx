...
export function SignInPage({ setIsLoggedIn }) {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-start pb-5 pt-5">
      ...
      <div className="font-Laqucer mb-5 flex h-72 w-[93%] flex-col justify-center gap-5 rounded-xl border-2 border-white bg-black bg-black pb-5 pl-5 pr-5 pt-2 font-Koho text-white drop-shadow-2xl">
        <form
